...
def test_email_status_endpoint(monkeypatch):
    ...
    response = client.get("/api/internal/ops/notifications/email", headers={"X-Admin-Token": "sk_TBn8_PzP-CD9BIODfdILDRQqIy_yGAb6kfbvHeanG2g"})
